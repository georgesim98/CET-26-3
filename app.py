...
def index():
    if request.method =="POST":
        ...
        pred3 = model2.predict([[purchases,suppcard]])
        return(render_template("index2.html", result1=pred1, result2=pred2, result3=pred3))
    else:
        return(render_template("index2.html", result1="2", result2="2", result3="2"))
